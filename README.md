![docker image](https://github.com/hampusnasstrom/nomad-sintering-image/actions/workflows/docker-publish.yml/badge.svg)
...
```sh
curl -L -o nomad-oasis.zip "https://github.com/hampusnasstrom/nomad-sintering-image/raw/main/nomad-oasis.zip"
```
...
your `docker-compose.yaml` with `ghcr.io/hampusnasstrom/nomad-sintering-image:main` for the services
 ...
 *I get an* `Error response from daemon: Head "https://ghcr.io/v2/hampusnasstrom/nomad-sintering-image/manifests/main": unauthorized`
